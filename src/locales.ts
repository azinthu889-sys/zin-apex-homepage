...
const my: typeof en = {
  ...
  hero: {
    ...
    titleLead: 'ဂျပန်ဆီ ခရီးကြမ်းမှာ ',
    titleAccent: 'သင့်အတွက် တံတားတစ်စင်း',
    subtitle:
      'လျှောက်လွှာကနေ ဂျပန်မြေ ခြေချသည်အထိ — ခက်ခဲရှုပ်ထွေးတဲ့ ခရီးလမ်းတစ်လျှောက်လုံး Zin Apex က တံတားသဖွယ် ကူးပေးသွားပါမယ်။',

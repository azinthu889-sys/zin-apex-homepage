...
const en = {
  ...
  aboutSection: {
    ...
    founderBio: [
      'Hello — I\'m Zin Thu Aung.',
      'I first set foot in Japan as a student. From language school I went on to university, graduating with a degree in Business Management (経営学), and after that I worked at a Japanese company as a shakaijin. Every step of that road, I walked myself.',
      'Zin Apex Education was founded on what that journey taught me — the difficulties, the challenges and the lessons — so that the next generation of young people who want to study in Japan have someone to show them the way.',
      'Our purpose is simple: to build a fully transparent, trustworthy path for every young person who wants to study in Japan. Because the help we give comes from experience we have actually lived, we promise it one hundred per cent — with Zin Apex Education beside you, you can bring your Japan dream to life with real peace of mind.',
    ],
  ...
  journey: [
    ...
    },
    {
      ...
      description: 'We match you with a reputable language school in one of our seven partner cities.',
    },
    {
      title: 'Documents & COE',
  ...
  leadForm: {
    ...
    subtitle:
      'Tell us a little about yourself and our team will reach out with the best path to Japan for you.',
    name: 'Name',
    ...
    successBody: 'We have received your request and will contact you very soon.',
    again: 'Send another request',
    error: 'Something went wrong. Please try again or contact us directly.',
    secondary: 'Prefer our Google Form? Register here',
  },
  footer: {
    tagline:
...
const ja: typeof en = {
  ...
  quick: [
    ...
    { title: '2027年度 入学日程', description: '4月・7月・10月入学 — 締切とCOE日程はこちら。' },
  ],
  support: {
    eyebrow: 'サポート',
  ...
  aboutSection: {
    ...
    founderRole: '創設者・教育者',
    founderBio: [
      'こんにちは。Zin Thu Aungと申します。',
      '私は留学生として日本に来て、日本語学校から大学へ進み、経営学を専攻して卒業しました。その後は日本企業で社会人として働くところまで、一段ずつ自分の足で歩んできました。',
      'その道のりで実際にぶつかった困難や課題、そこで得た学びをもとに、日本で学びたいと願う次の世代の若者たちの道しるべになりたいと考え、Zin Apex Educationを立ち上げました。',
      'Zin Apex Educationの何よりの目的は、日本で学びたい一人ひとりに、透明性が高く、信頼できる道筋をつくることです。自分自身が歩いてきた経験にもとづいて本当に必要な支援をお届けしますので、Zin Apex Educationと一緒なら、安心して日本への夢を形にしていただけると、100%の自信をもってお約束します。',
    ],
  ...
  journey: [
    ...
    { title: '学校選び', description: '7つの提携都市から、あなたに合う優良校をご紹介します。' },
  ...
  intakes: [
    { intake: '2027年4月入学', registration: '2026年9月', coeSubmission: '2026年10月', coeResult: '2027年2月' },
    { intake: '2027年7月入学', registration: '2026年12月', coeSubmission: '2027年1月', coeResult: '2027年5月' },
    { intake: '2027年10月入学', registration: '2027年3月', coeSubmission: '2027年4月', coeResult: '2027年8月' },
  ],
  cities: ['東京', '千葉', '静岡', '浜松', '大阪', '神戸', '福岡'],
  storiesSection: {
    eyebrow: '学生の声',
    title: '先輩たちのストーリー',
  ...
  leadForm: {
    ...
    title: '無料の留学プランを受け取る',
    subtitle:
      '簡単なご記入で、あなたに最適な日本への進路を私たちのチームがご案内します。',
    name: 'お名前',
...
const my: typeof en = {
  ...
  hero: {
    ...
    subtitle:
      'ကျောင်းလျှောက်တဲ့နေ့ကနေ ဂျပန်ရောက်တဲ့နေ့အထိ — မြန်မာကျောင်းသားတွေ ဂျပန်မှာ ပညာသင်နိုင်ဖို့ အစအဆုံး လမ်းပြ ကူညီပေးပါတယ်။',
    cta1: 'အခမဲ့ တိုင်ပင်ဆွေးနွေးရန်',
    cta2: 'သင်တန်းများ ကြည့်ရန်',
    trust1: '၂၀၂၃ ခုနှစ်ကတည်းက ယုံကြည်စိတ်ချရ',
    trust2: 'တည်ထောင်သူ ကိုယ်တိုင် ဂျပန်မှာ',
    trust3: 'COE အောင်မြင်နှုန်း {rate}%',
    caption: 'ဂျပန်ရောက်ရှိလာသော ZAE ကျောင်းသားများ ✈️',
    badgeTop: '၁၀၀+',
    badgeBottom: 'ဂျပန်ရောက်ပြီး ကျောင်းသား',
  },
  quick: [
    {
      title: 'အခမဲ့ တိုင်ပင်ဆွေးနွေးမှု',
      description: 'ဘယ်ကျောင်း၊ ဘယ် intake က သင့်အတွက် အကောင်းဆုံးလဲ — ကျွန်ုပ်တို့နဲ့ အခမဲ့ တိုင်ပင်နိုင်ပါတယ်။',
    },
    {
      title: 'လျှောက်လွှာဖောင်',
      description: 'ZAE လျှောက်လွှာ (PDF) ကို ဒေါင်းလုဒ်လုပ်ပြီး ဒီနေ့ပဲ လျှောက်ထားလိုက်ပါ။',
    },
    {
      title: '၂၀၂၇ Intake အချိန်ဇယား',
      description: 'ဧပြီ၊ ဇူလိုင်၊ အောက်တိုဘာ intake တွေရဲ့ လျှောက်ရမယ့် နောက်ဆုံးလနဲ့ COE ရက်တွေ ကြည့်ပါ။',
    },
  ],
  support: {
    eyebrow: 'ပံ့ပိုးမှု',
    title: 'ကျောင်းသား ပံ့ပိုးမှု အပြည့်အစုံ',
    subtitle: 'ကျောင်းအပ်တဲ့နေ့ကနေ ပန်းတိုင်ရောက်တဲ့အထိ — အဆင့်တိုင်းမှာ ဘေးကနေ အတူရှိပေးပါမယ်။',
    photoCaption: 'Orientation နေ့ — ZAE မိသားစု',
  },
  achievements: [
    'စုစုပေါင်း COE အောင်မြင်နှုန်း',
    'Online နဲ့ အပြည့်အဝ လျှောက်နိုင်',
    'စတင်တည်ထောင်ခဲ့သည့်နှစ်',
  ...
  videoSection: {
    ...
    subtitle:
      'ကျွန်ုပ်တို့ ဘယ်သူတွေလဲ၊ ကျောင်းသားတွေကို ဂျပန်အထိ ဘယ်လို လမ်းပြပေးလဲ — ဒီဗီဒီယိုလေးမှာ ကြည့်လိုက်ပါ။',
  },
  aboutSection: {
    eyebrow: 'အကြောင်း',
    title: 'Zin Apex Education အကြောင်း',
    intro:
      'Zin Apex Education က ဂျပန်ဘာသာ သင်တန်းတွေ ပို့ချပေးသလို ဂျပန်မှာ ပညာဆက်သင်ချင်သူတွေအတွက် ကျောင်းလျှောက်တဲ့ အဆင့်ကနေ ဂျပန်ရောက်တဲ့အထိ ဝန်ဆောင်မှု အပြည့်အစုံ ပေးနေပါတယ်။',
    detail:
    ...
    founderBio: [
      'မင်္ဂလာပါ၊ ကျွန်တော် Zin Thu Aung ပါ။',
      'ဂျပန်နိုင်ငံကို ကျောင်းသားတစ်ယောက်အနေနဲ့ စတင်ခြေချခဲ့ချိန်ကတည်းက ဘာသာစကားကျောင်း၊ ၎င်းမှတစ်ဆင့် တက္ကသိုလ်မှာ စီးပွားရေးစီမံခန့်ခွဲမှု (経営学) အထူးပြု ဘွဲ့ရရှိခဲ့ပြီး၊ ကျောင်းပြီးနောက် ဂျပန်ကုမ္ပဏီမှာ 社会人 တစ်ယောက်အနေနဲ့ အလုပ်လုပ်ကိုင်ခဲ့တဲ့အထိ အဆင့်ဆင့် ဖြတ်သန်းခဲ့သူ ဖြစ်ပါတယ်။',
      'ဒီလို ကိုယ်တိုင် အစကနေ အဆုံးထိ ဖြတ်သန်းခဲ့ရတဲ့ ခရီးလမ်းမှာ ကြုံတွေ့ခဲ့ရတဲ့ အခက်အခဲတွေ၊ စိန်ခေါ်မှုတွေနဲ့ သင်ခန်းစာတွေကို အခြေခံပြီး ဂျပန်မှာ ပညာသင်ယူချင်ကြတဲ့ မျိုးဆက်သစ် လူငယ်တွေအတွက် လမ်းပြတစ်ခု ဖြစ်စေဖို့ Zin Apex Education ကို တည်ထောင်ခဲ့ခြင်း ဖြစ်ပါတယ်။',
      'ကျွန်တော်တို့ Zin Apex Education ရဲ့ ပင်မရည်ရွယ်ချက်ကတော့ ဂျပန်မှာ ပညာသင်ကြားချင်သည့် လူငယ်တစ်ယောက်ချင်းစီအတွက် ပွင့်လင်းမြင်သာမှု အပြည့်ရှိပြီး မှန်ကန်စိတ်ချရတဲ့ လမ်းကြောင်းကို ဖန်တီးပေးဖို့ ဖြစ်ပါတယ်။ ကိုယ်တိုင် ကြုံတွေ့ခဲ့ရတဲ့ အတွေ့အကြုံတွေနဲ့ အမှန်တကယ် ကူညီပေးမှာမို့လို့ Zin Apex Education နဲ့အတူဆိုရင် သင့်ရဲ့ ဂျပန်အိပ်မက် ခရီးစဉ်ကို စိတ်အေးချမ်းသာစွာနဲ့ အကောင်အထည်ဖော်နိုင်မယ်လို့ ရာနှုန်းပြည့် အာမခံပါတယ်။',
    ],
    youtubeLink: 'YouTube — Zin Japan Life',
    ...
    missionItems: [
      ...
      'ဂျပန်လူ့ဘောင်မှာ နေသားကျပြီး အောင်မြင်နိုင်စေရန် ဘာသာစကားရော ယဉ်ကျေးမှုပါ သင်ကြားလေ့ကျင့်ပေးရန်။',
    ],
    visionText:
    ...
    purposeItems: [
      ...
      'နိုင်ငံခြားမှာ နေထိုင်စဉ် ကြုံရတဲ့ အခက်အခဲတွေကို ကျော်လွှားနိုင်အောင် မြန်မာ ညီအစ်ကိုမောင်နှမတွေကို ကူညီပေးရန်။',
      'အရည်အချင်းရှိပြီး စိတ်အားထက်သန်တဲ့ လူငယ်တွေ စုစည်းထားတဲ့ ခိုင်မာပြီး အားကျစရာကောင်းတဲ့ အသိုက်အဝန်းတစ်ခု တည်ဆောက်ရန်။',
    ],
  },
  servicesSection: {
    eyebrow: 'ဝန်ဆောင်မှုများ',
    title: 'အဆင့်တိုင်း ပံ့ပိုးမှု အပြည့်အစုံ',
    subtitle: 'ပထမဆုံး လျှောက်လွှာကနေ ဂျပန်ရောက်တဲ့နေ့အထိ။',
    whyTitle: 'ကျောင်းသားတွေ Zin Apex Education ကို ဘာကြောင့် ရွေးကြလဲ?',
  },
  services: [
    {
      ...
      items: [
        ...
        'COE လျှောက်ထားမှုနှင့် ပူးတွဲ စာရွက်စာတမ်းများ စုစည်းပေးခြင်း',
      ],
    },
    {
  ...
  whyChooseUs: [
    ...
    {
      title: 'ကျောင်းသားတွေ ယုံကြည်အားထားကြ',
      description:
        'ကျွန်ုပ်တို့မှတစ်ဆင့် လျှောက်ခဲ့တဲ့ ကျောင်းသား အများအပြားက ကျေနပ်ယုံကြည်ကြောင်း ကောင်းမွန်တဲ့ review တွေ ပေးခဲ့ကြပါတယ်။',
    },
    {
    ...
    {
      title: 'ကုန်ကျစရိတ် ပွင့်လင်းမြင်သာမှု',
      description:
        'ကုန်ကျစရိတ် အားလုံးကို ပွင့်ပွင့်လင်းလင်း ရိုးရိုးသားသား ရှင်းပြပေးလို့ ကျောင်းသားနဲ့ မိသားစုတွေ စိတ်ချနိုင်ပါတယ်။',
    },
    {
      title: 'မျှတသော ဝန်ဆောင်ခ',
      description:
        'ရရှိမယ့် ပံ့ပိုးမှု အပြည့်အစုံနဲ့ ထိုက်တန်တဲ့ သင့်တင့်မျှတတဲ့ ဝန်ဆောင်ခသာ ကောက်ခံပါတယ်။',
    },
    {
  ...
  journeySection: {
    ...
    subtitle: 'ပထမဆုံး တိုင်ပင်တဲ့နေ့ကနေ ဂျပန်မှာ ပထမဆုံးနေ့အထိ — ရှင်းလင်းတဲ့ အဆင့်ဆင့် လမ်းညွှန်မှု။',
  },
  journey: [
    {
      title: 'အခမဲ့ တိုင်ပင်ခြင်း',
      description: 'သင့်ရည်မှန်းချက်၊ ဘတ်ဂျက်နဲ့ သင့်တော်ဆုံး intake အတွက် ဆွေးနွေးပါ။',
    },
    {
      title: 'ကျောင်းရွေးခြင်း',
      description: 'မိတ်ဖက်မြို့ ၇ မြို့ထဲက နာမည်ကောင်း ကျောင်းတစ်ကျောင်းနဲ့ ချိတ်ဆက်ပေးပါတယ်။',
    },
    {
    ...
    },
    {
      ...
      description: 'ဗီဇာ လျှောက်ထားမှု၊ လေယာဉ်လက်မှတ်နဲ့ မထွက်ခင် orientation အထိ စီစဉ်ပေးပါတယ်။',
    },
    {
      title: 'ဂျပန်ရောက်ခြင်း',
  ...
  coursesSection: {
    ...
    features: 'သင်ခန်းစာများ',
    enroll: 'အပ်နှံရန်',
    flexibleTitle: 'ကိုယ်နဲ့ကိုက်တဲ့ သင်ယူနည်း ရွေးပါ',
    whyTitle: 'ကျွန်ုပ်တို့ သင်တန်းတွေ ဘာကြောင့် ထိရောက်လဲ',
  },
  courses: [
    {
      ...
      duration: '၃ လ',
      description:
        'ဟီရဂနာ၊ ခတကနာ၊ အခြေခံ သဒ္ဒါနဲ့ နေ့စဉ်သုံး ဝေါဟာရတွေကနေ ဂျပန်စာ အုတ်မြစ်ကို ခိုင်ခိုင်မာမာ ချပေးပါတယ်။',
      features: [
        'ဟီရဂနာ၊ ခတကနာနှင့် အခြေခံ ခန်းဂျိ',
    ...
    {
      title: 'ဂျပန်ဘာသာ N4 အဆင့်',
      level: 'အခြေခံ အဆင့်မြင့်',
      duration: '၄ လ',
      description: 'JLPT N4 စာမေးပွဲအတွက် သဒ္ဒါ၊ ခန်းဂျိ၊ အဖတ်နဲ့ အကြား စွမ်းရည်ကို အဆင့်မြှင့်ပေးပါတယ်။',
      features: [
        'ခန်းဂျိ ၃၀၀ ကျော်',
        'ပိုမိုကျယ်ပြန့်တဲ့ သဒ္ဒါပုံစံများ',
        'စာဖတ်ပြီး နားလည်နိုင်စွမ်း',
    ...
    },
    {
      ...
      description: 'ဂျပန်မှာ နေ့စဉ်ဘဝအတွက် ရဲရဲတင်းတင်း သွက်သွက်လက်လက် ပြောနိုင်အောင် စကားပြောကို အဓိကထား သင်ပေးပါတယ်။',
      features: ['စကားပြောကို အဓိကထားတဲ့ သင်ခန်းစာ', 'ရဲရဲတင်းတင်း သွက်သွက်လက်လက် ပြောနိုင်အောင်', 'လက်တွေ့ဘဝ အခြေအနေတွေနဲ့ လေ့ကျင့်ခြင်း'],
    },
    {
      title: 'လက်တွေ့ ကျွမ်းကျင်မှု သင်တန်း',
      level: 'အဆင့်မရွေး',
      duration: 'အချိန်ညှိနိုင်',
      description: 'ဂျပန်မှာ နေထိုင်ရင်း ပညာသင်ရာမှာ အဆင်ပြေပြေ နေသားကျစေမယ့် လက်တွေ့ စွမ်းရည်နဲ့ ယဉ်ကျေးမှု ဗဟုသုတတွေ။',
      features: ['ဂျပန် ယဉ်ကျေးမှု ဗဟုသုတ', 'နေ့စဉ်ဘဝ လက်တွေ့ ကျွမ်းကျင်မှု', 'ဂျပန်ဘဝနဲ့ နေသားကျဖို့ လမ်းညွှန်'],
    },
  ],
  learningFormats: [
    { title: 'ဗီဒီယို', description: 'အချိန်မရွေး ကိုယ့်နှုန်းနဲ့ကိုယ် လေ့လာနိုင်တဲ့ သင်ခန်းစာများ။' },
    { title: 'Zoom', description: 'ဆရာနဲ့ တိုက်ရိုက် မေးမြန်းဆွေးနွေးနိုင်တဲ့ online live အတန်းများ။' },
    { title: 'Zoom + ဗီဒီယို', description: 'Live အတန်းတက်ပြီး recording ပါ ပြန်ကြည့်နိုင်လို့ အချိန်မရွေး ပြည့်ပြည့်စုံစုံ လေ့လာနိုင်ပါတယ်။' },
  ],
  whyCoursesWork: [
    {
    ...
    },
    {
      ...
      description: 'ပုံမှန် စာမေးပွဲတွေက နားလည်မှုကို ခိုင်မာစေပြီး အမှတ်ကောင်းအောင် ကူညီပေးပါတယ်။',
    },
    {
    ...
    {
      title: 'အဖတ်၊ အကြား အပို လေ့ကျင့်ခန်းများ',
      description: 'ပြဋ္ဌာန်းစာအုပ်အပြင် အဖတ်၊ အကြား စွမ်းရည် တိုးစေမယ့် အပို လေ့ကျင့်ခန်းတွေ ပေးပါတယ်။',
    },
    {
      title: 'JLPT စာမေးပွဲဟောင်းများဖြင့် လေ့ကျင့်မှု',
      description: 'မေးခွန်းဟောင်းတွေ လေ့ကျင့်ဖြေဆိုထားလို့ တကယ့် JLPT စာမေးပွဲကို ယုံကြည်မှုအပြည့်နဲ့ ဖြေနိုင်ပါတယ်။',
    },
  ],
  studySection: {
    eyebrow: 'ဂျပန်ပညာတော်သင်',
    title: 'ဂျပန် ဘာသာစကားကျောင်း တက်ဖို့ လမ်းကြောင်း',
    ...
    formBody:
      'လျှောက်လွှာ (PDF) ကို ဒေါင်းလုဒ်လုပ်ပြီး ဖြည့်ကာ ပြန်ပို့ပေးပါ။ လိုအပ်တဲ့ ပူးတွဲ စာရွက်တွေက Google Drive folder ထဲမှာ ရှိပါတယ်။',
    download: 'ဖောင် ရယူရန်',
    viewSample: 'နမူနာ ကြည့်ရန်',
    driveLink: 'Drive folder ဖွင့်ရန်',
    orientationTitle: 'ကျောင်းသား Orientation',
    orientationBody:
      'Google Form ကနေ စာရင်းပေးပြီး orientation ကို တက်ရောက်ပါ — ကျောင်းလျှောက်ရာမှာ သိထားရမယ့် အရေးကြီး အချက်အလက်တွေ ရပါမယ်။',
    register: 'ယခုပဲ စာရင်းသွင်းရန်',
    intakeTitle: 'Intake အချိန်ဇယားများ',
    intakeHead: ['Intake', 'လျှောက်ရန် နောက်ဆုံးလ', 'COE တင်မည့်လ', 'COE ရလဒ်ထွက်မည့်လ'],
    citiesTitle: 'ကျွန်ုပ်တို့နဲ့ လျှောက်နိုင်တဲ့ မြို့များ',
  },
  requiredDocuments: [
    'နိုင်ငံကူးလက်မှတ် (Passport)',
    'ကျောင်းသား၊ အာမခံသူ (Sponsor) နှင့် မိဘများ၏ မှတ်ပုံတင် (NRC)',
    'အိမ်ထောင်စုစာရင်း',
    ...
    'ဂျပန်ဘာသာ သင်တန်း တက်ရောက်ကြောင်း ထောက်ခံစာ',
    'Show money အထောက်အထား ဘဏ်စာရင်း (ကျပ် သိန်း ၄၀ ခန့်)',
    'ဓာတ်ပုံ (3cm x 4cm)',
  ],
  intakes: [
    {
      intake: '၂၀၂၇ ဧပြီ Intake',
      registration: '၂၀၂၆ စက်တင်ဘာ',
      coeSubmission: '၂၀၂၆ အောက်တိုဘာ',
      coeResult: '၂၀၂၇ ဖေဖော်ဝါရီ',
    },
    {
      intake: '၂၀၂၇ ဇူလိုင် Intake',
      registration: '၂၀၂၆ ဒီဇင်ဘာ',
      coeSubmission: '၂၀၂၇ ဇန်နဝါရီ',
      coeResult: '၂၀၂၇ မေ',
    },
    {
      intake: '၂၀၂၇ အောက်တိုဘာ Intake',
      registration: '၂၀၂၇ မတ်',
      coeSubmission: '၂၀၂၇ ဧပြီ',
      coeResult: '၂၀၂၇ သြဂုတ်',
    },
  ],
  cities: ['တိုကျို', 'ချီဘာ', 'ရှီဇူအိုကာ', 'ဟာမားမတ်ဆု', 'အိုဆာကာ', 'ကိုဘေး', 'ဖူကူအိုကာ'],
  storiesSection: {
    eyebrow: 'ကျောင်းသား အတွေ့အကြုံများ',
    title: 'ကျောင်းသားတွေရဲ့ အောင်မြင်မှု ဇာတ်လမ်းများ',
    ...
    schools: ['တိုကျို ဘာသာစကားကျောင်း', 'ရှီဇူအိုကာ ဘာသာစကားကျောင်း', 'ဟာမားမတ်ဆု ဘာသာစကားကျောင်း'],
  ...
  testimonialsSection: {
    ...
    subtitle: 'ဂျပန်မှာ ပညာသင်ရင်း နေထိုင်နေကြတဲ့ ZAE ကျောင်းသားတွေရဲ့ ကိုယ်တွေ့ အသံများ။',
  },
  testimonials: [
    {
      name: 'Myint Myat Theingi',
      intake: 'Facebook မှ review',
      quote:
  ...
  resultsSection: {
    ...
    tagline: 'မှန်ကန်တဲ့ ရွေးချယ်မှု၊ တိကျတဲ့ လမ်းညွှန်မှု၊ စိတ်ချရတဲ့ ဂျပန်ပညာသင်ခရီး။',
    subtitle:
  ...
  faqs: [
    {
      ...
      a: 'အထက်တန်း အောင်လက်မှတ် မရှိရင်လည်း GED (သို့) အထက်တန်းနဲ့ ညီမျှတဲ့ လက်မှတ်တစ်ခုခု ရှိရင် လျှောက်လို့ရပါတယ်။',
    },
    {
      q: 'အသက် ကန့်သတ်ချက် ရှိလား?',
      a: 'အသက် ကန့်သတ်ချက် မရှိပါဘူး။ ဒါပေမဲ့ လျှောက်မယ့် intake နဲ့ ကျောင်းပေါ် မူတည်လို့ အသေးစိတ်ကို တိုင်ပင်ပေးပါမယ်။',
    },
    {
      q: 'ကျောင်းအင်တာဗျူးအတွက် လေ့ကျင့်ပေးလား?',
      a: 'ပေးပါတယ်။ ကျောင်းအင်တာဗျူးအတွက် online ကနေ လေ့ကျင့်ပေးပါတယ်။',
    },
    {
      q: 'ကျောင်းလခကို ၆ လစာ ခွဲသွင်းလို့ ရလား?',
      a: 'ရပါတယ်။ ဒါပေမဲ့ ပထမနှစ်အတွက်တော့ တစ်နှစ်စာ အပြည့်သွင်းရပြီး ဒုတိယနှစ်ကစပြီး အရစ်ကျ ခွဲသွင်းလို့ရပါတယ်။',
    },
    {
      q: 'ကျောင်းလခကို ယန်းနဲ့ သွင်းလို့ ရလား?',
      a: 'ရပါတယ်။ ဘာသာစကားကျောင်းက invoice ပို့ပေးမှာဖြစ်လို့ ဂျပန်မှာရှိတဲ့ အသိမိတ်ဆွေတွေကနေတစ်ဆင့် ကျောင်းရဲ့ ဘဏ်အကောင့်ထဲ ယန်းနဲ့ တိုက်ရိုက် သွင်းလို့ရပါတယ်။',
    },
    {
      q: 'နယ်မှာ နေလို့ ရုံးကို ကိုယ်တိုင် လာဖို့ လိုသလား?',
      a: 'မလိုပါဘူး။ စတင်စုံစမ်းတဲ့အချိန်ကနေ အင်တာဗျူး လေ့ကျင့်ခြင်း၊ ကျောင်းအင်တာဗျူး ဖြေဆိုခြင်း၊ COE ရလဒ်ထွက်တဲ့အထိ အားလုံးကို online ကနေ အဆင်ပြေအောင် ဆောင်ရွက်ပေးပါတယ်။',
    },
    {
      q: 'ဘယ်လို အဆင့်တွေနဲ့ ဆောင်ရွက်ပေးလဲ?',
      a: 'Orientation လုပ်ပြီး ကျောင်းရွေးချယ်ပုံကို အသေးစိတ် ရှင်းပြပေးပါတယ်။ ပြီးရင် COE အတွက် စာရွက်စာတမ်းတွေ၊ ဗီဇာနဲ့ လေဆိပ်ဆိုင်ရာ စာရွက်စာတမ်းတွေ ပြင်ဆင်ပေးပြီး လေဆိပ်အထိ ပို့ပေးပါတယ်။ ဂျပန်ရောက်ရင်လည်း တာဝန်ခံက လေဆိပ်ကို လာကြိုပြီး အဆောင်အထိ ပို့ပေးပါတယ်။',
    },
    {
      q: 'နိုင်ငံခြားမှာ ရောက်နေတဲ့ မြန်မာတွေကိုရော လျှောက်ပေးလား?',
      a: 'ပေးပါတယ်။ နိုင်ငံခြားမှာ ရေရှည်နေထိုင်ခွင့် ဗီဇာ ရှိသူတွေကို လျှောက်ပေးပါတယ်။ (ဥပမာ — ED visa၊ work visa)',
    },
    {
      q: 'ဘာသာစကားကျောင်း ပြီးရင် အလုပ်လုပ်လို့ ရလား?',
      a: 'ရပါတယ်။ ဘာသာစကားကျောင်းပြီးရင် တက္ကသိုလ် ဆက်မတက်ဘဲ အလုပ်ကို ပြောင်းလုပ်လို့ရပါတယ်။ Tokutei (特定技能) အလုပ် မိတ်ဆက်ပေးတဲ့ ဘာသာစကားကျောင်းတွေကိုလည်း လျှောက်လို့ရပါတယ်။',
    },
  ],
  contactCta: {
  ...
  leadForm: {
    eyebrow: 'အခမဲ့ တိုင်ပင်ဆွေးနွေးမှု',
    title: 'အခမဲ့ ပညာသင် အစီအစဉ် ရယူပါ',
    subtitle:
      'သင့်အကြောင်း အနည်းငယ် ဖြည့်ပေးလိုက်ရင် သင့်အတွက် သင့်တော်ဆုံး ဂျပန်ခရီးလမ်းကို ကျွန်ုပ်တို့အဖွဲ့က ဆက်သွယ် အကြံပြုပေးပါမယ်။',
    name: 'အမည်',
    namePlaceholder: 'သင့်အမည်',
    phone: 'ဖုန်း / Viber',
    phonePlaceholder: '09 ...',
    goal: 'သင့်ရည်မှန်းချက်',
    goalOptions: ['တက္ကသိုလ်', 'သက်မွေးပညာကျောင်း (Senmon)', 'ဘာသာစကားကျောင်း'],
    level: 'လက်ရှိ ဂျပန်စာ အဆင့်',
    levelOptions: ['လုံးဝ မသင်ရသေး', 'အခြေခံ', 'N5–N4'],
    intake: 'လိုချင်တဲ့ Intake',
    intakeOptions: ['ဧပြီ', 'ဇူလိုင်', 'အောက်တိုဘာ', 'ဇန်နဝါရီ'],
    selectPlaceholder: 'ရွေးပါ',
    submit: 'အခမဲ့ တိုင်ပင်ချင်ပါတယ်',
    sending: 'ပို့နေသည်…',
    successTitle: 'ကျေးဇူးတင်ပါတယ်!',
    successBody: 'သင့်တောင်းဆိုမှုကို လက်ခံရရှိပါပြီ။ မကြာမီ ဆက်သွယ်ပေးပါမယ်။',
    again: 'နောက်တစ်ခု ထပ်ပို့ရန်',
    error: 'တစ်ခုခု မှားယွင်းသွားပါတယ်။ ထပ်စမ်းကြည့်ပါ သို့မဟုတ် တိုက်ရိုက် ဆက်သွယ်ပါ။',
    secondary: 'Google Form နဲ့ စာရင်းပေးချင်ရင် ဒီမှာ နှိပ်ပါ',
  },
  footer: {
    tagline:
  ...
  aboutPage: {
    ...
    founderYoutube:
      'YouTube မှာ Zin Japan Life channel ကိုလည်း လုပ်နေပြီး ဂျပန်မှာ နေနေတဲ့ (သို့) လာဖို့ စီစဉ်နေတဲ့ မြန်မာတွေအတွက် vlog၊ ဗဟုသုတနဲ့ အကြံပြုချက်၊ ဗီဇာ အချက်အလက်၊ ဂျပန်စာ သင်ခန်းစာနဲ့ လက်တွေ့ဘဝ လမ်းညွှန်တွေ မျှဝေနေပါတယ်။',
    qualifications: 'ပညာအရည်အချင်း',
    qualificationItems: [
      'ဟာမားမတ်ဆု ဂျပန်ဘာသာ ကောလိပ် — ပြီးဆုံး',
      'ရှီဇူအိုကာ အေဝါ တက္ကသိုလ်၊ ဂျပန် (စီးပွားရေး စီမံခန့်ခွဲမှု)',
      'ရတနာပုံ တက္ကသိုလ်၊ မန္တလေး',
    ],
    ctaTitle: 'Zin Apex Education မိသားစုထဲ ပါဝင်လိုက်ပါ',
  ...
  coursesPage: {
    ...
    enroll: 'အပ်နှံရန်',
    textbooksTitle: 'N4 ပြဋ္ဌာန်းစာအုပ်နှင့် သင်ထောက်ကူများ',
    textbooksBody:

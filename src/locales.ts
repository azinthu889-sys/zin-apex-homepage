...
const my: typeof en = {
  ...
  hero: {
    ...
    titleLead: 'ဂျပန်နိုင်ငံဆီသို့ ',
    titleAccent: 'သင့်တံခါးပေါက်',
    subtitle:
    ...
    trust1: '၂၀၂၃ ကတည်းက ယုံကြည်အားထားခံရ',
    trust2: 'ကျောင်းသား ၁၀၀ ကျော် ဂျပန်ရောက်ပြီး',
  ...
  whyChooseUs: [
    ...
    {
      title: 'ပွင့်လင်းမြင်သာသော ငွေကြေးရှင်းလင်းမှု',
      description:

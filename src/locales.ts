...
const my: typeof en = {
  ...
  leadForm: {
    ...
    goalOptions: ['တက္ကသိုလ်', 'အသက်မွေး သင်တန်းကျောင်း', 'ဘာသာစကားကျောင်း'],
    level: 'လက်ရှိ ဂျပန်စာ အဆင့်',
    levelOptions: ['အခြေခံ မတတ်သေး', 'အခြေခံ', 'N5–N4'],
    intake: 'လိုချင်တဲ့ Intake',
    intakeOptions: ['ဧပြီ', 'ဇူလိုင်', 'အောက်တိုဘာ', 'ဇန်နဝါရီ'],
    selectPlaceholder: 'ရွေးပါ',
    submit: 'အခမဲ့ တိုင်ပင်ဆွေးနွေးရန် တောင်းဆိုမည်',
    sending: 'ပို့နေသည်…',
    ...
    secondary: 'Google Form နဲ့ စာရင်းသွင်းလိုပါက ဒီမှာ',
  },
  footer: {
    tagline:

...
const en = {
  ...
  aboutSection: {
    ...
    founderBio: [
      'I\'m Zin Thu Aung. I came to Japan as an international student myself. I went from language school on to university here and graduated in Business Management, and after that I spent time working in Japan as a shakaijin — earning my living here, not just studying. So I have seen this country from both sides.',
      'The hardest part was never the studying. It was having nobody to ask. Which school actually suited me, how the paperwork had to be put together, what to do in those first weeks after landing — I worked it all out by trying, getting it wrong, and trying again.',
      'That is why Zin Apex Education exists. I did not want the students coming after me to feel their way through it the way I had to. A clear path, honest information, and someone beside them — from the first language class to the day life in Japan finally feels steady.',
    ],
...
const ja: typeof en = {
  ...
  aboutSection: {
    ...
    founderRole: '創設者・教育者',
    founderBio: [
      'Zin Thu Aungと申します。私も留学生として日本に来た一人です。日本語学校から大学へ進み、経営学を学んで卒業しました。その後は社会人として日本で働いた経験もあり、学生としても、働く側としても、この国を見てきました。',
      '一番大変だったのは、勉強ではありませんでした。聞ける人が誰もいなかったことです。どの学校が自分に合うのか、書類はどう揃えるのか、来日してからの数週間をどう過ごせばいいのか——全部、自分で試して、間違えて、やり直しながら進みました。',
      'だからこそ、Zin Apex Educationを立ち上げました。後から来る学生には、私と同じように手探りをしてほしくない。はっきりした道筋と、正直な情報と、そばにいる人。語学の最初の一歩から、日本での暮らしが落ち着くその日まで、一緒に歩いていきます。',
    ],
...
const my: typeof en = {
  ...
  aboutSection: {
    ...
    founderBio: [
      'ကျွန်တော် Zin Thu Aung ပါ။ ဂျပန်ကို 留学生 တစ်ယောက်အနေနဲ့ စလာခဲ့သူပါ။ ဘာသာစကားကျောင်းကနေ တက္ကသိုလ်ကို ဆက်တက်ပြီး စီးပွားရေး စီမံခန့်ခွဲမှု (経営学) နဲ့ ဘွဲ့ရခဲ့ပါတယ်။ ကျောင်းပြီးတော့ 社会人 တစ်ယောက်အနေနဲ့ ဂျပန်မှာ အလုပ်လုပ်ကိုင်ခဲ့တဲ့ အတွေ့အကြုံလည်း ရှိပါတယ် — ဒီနိုင်ငံကို ကျောင်းသားတစ်ယောက်ရဲ့ အမြင်ကရော၊ အလုပ်လုပ်နေသူတစ်ယောက်ရဲ့ အမြင်ကပါ မြင်ဖူးခဲ့ပါတယ်။',
      'ဒီခရီးမှာ အခက်ဆုံးက စာကျက်ရတာ မဟုတ်ပါဘူး။ မေးစရာ လူတစ်ယောက်မှ မရှိခဲ့တာပါ။ ဘယ်ကျောင်းက ကိုယ်နဲ့ လိုက်ဖက်လဲ၊ စာရွက်စာတမ်းတွေ ဘယ်လို ပြင်ဆင်ရမလဲ၊ ဂျပန်ရောက်ပြီး ပထမဆုံး ရက်သတ္တပတ်တွေမှာ ဘာလုပ်ရမလဲ — အားလုံးကို ကိုယ့်ဘာသာ စမ်းပြီး၊ မှားပြီး၊ ပြန်ပြင်ရင်း သွားခဲ့ရတာပါ။',
      'ဒါကြောင့် Zin Apex Education ကို စတင်ခဲ့တာပါ။ ကျွန်တော် ဖြတ်သန်းခဲ့ရသလို နောက်လာမယ့် ကျောင်းသားတွေ တစ်ယောက်တည်း မှန်းဆမနေရအောင် — ရှင်းရှင်းလင်းလင်း လမ်းကြောင်းတစ်ခု၊ ရိုးရိုးသားသား အချက်အလက်နဲ့ ဘေးမှာ ရှိပေးမယ့် လူတစ်ယောက် ဖြစ်ချင်လို့ပါ။ ဘာသာစကား ပထမဆုံးအတန်းကနေ ဂျပန်မှာ ဘဝ အခြေကျတဲ့နေ့အထိ အတူတူ လျှောက်သွားပါမယ်။',
    ],
    youtubeLink: 'YouTube — Zin Japan Life',

...
const en = {
  ...
  contactPage: {
    ...
    holiday: 'Holiday',
    holidayValue: 'Monday & Sunday (weekly)',
    followUs: 'Follow us',
    fullName: 'Full name',
...
const my: typeof en = {
  ...
  hero: {
    ...
    titleLead: 'ဂျပန်နိုင်ငံဆီ ',
    titleAccent: 'တံခါးပေါက်',
    subtitle:
      'မြန်မာကျောင်းသားများ ဂျပန်ထိပ်တန်း ဘာသာစကားကျောင်းများမှာ ပညာသင်နိုင်ဖို့ — လျှောက်လွှာကနေ ဂျပန်ရောက်သည်အထိ အပြည့်အဝ လမ်းညွှန်ကူညီပေးပါတယ်။',
    cta1: 'အခမဲ့ တိုင်ပင်ဆွေးနွေးရန်',
    cta2: 'သင်တန်းများ ကြည့်ရန်',
    trust1: '၂၀၂၃ ခုနှစ်ကတည်းက ယုံကြည်စိတ်ချရ',
    trust2: 'ကျောင်းသား ၁၀၀+ ဂျပန်ရောက်ပြီး',
  ...
  quick: [
    {
      ...
      description: 'သင့်ပညာရေးအစီအစဉ်နဲ့ သင့်တော်ဆုံး intake အတွက် ကျွန်ုပ်တို့နဲ့ ဆွေးနွေးပါ။',
    },
    {
  ...
  achievements: [
    ...
    'ဂျပန်ရောက် ကျောင်းသားဦးရေ',
    'စတင်တည်ထောင်သည့်နှစ်',
    'ဂျပန်ရှိ ပါတနာမြို့များ',
  ],
  aboutSection: {
    eyebrow: 'အကြောင်း',
    ...
    founderRole: 'တည်ထောင်သူနှင့် ပညာရေးပညာရှင်',
    founderBio:
    ...
    purposeItems: [
      ...
      'နိုင်ငံရပ်ခြားနေထိုင်စဉ် ကြုံတွေ့ရသော အခက်အခဲများကို ကျော်လွှားနိုင်အောင် အမျိုးသားချင်း ကူညီပေးရန်။',
  ...
  whyChooseUs: [
    ...
    {
      title: 'စာရွက်စာတမ်း တိကျစွာ ပြင်ဆင်',
      description:
        'စာရွက်စာတမ်းအားလုံးကို တိကျဂရုတစိုက် ပြင်ဆင်ပြီး ကျောင်းသားရော မိဘများပါ ရှင်းလင်းစွာ နားလည်အောင် ဆက်သွယ်ပြောကြားပါသည်။',
    },
    {
      title: 'ငွေကြေး ပွင့်လင်းမြင်သာ',
      description:
        'ငွေကြေးကိစ္စအားလုံးကို ရှင်းလင်းရိုးသားစွာ ရှင်းပြပေးသဖြင့် ကျောင်းသားနှင့် မိသားစုများ စိတ်ချယုံကြည်နိုင်ပါသည်။',
    },
    {
    ...
    {
      title: 'ဂျပန်ရောက်ပြီးလည်း ဆက်လက်ပံ့ပိုး',
      description:
        'ဂျပန်ရောက် senior များက အသစ်ရောက်လာသူများကို မိသားစုလို ဆက်ဆံပြီး ဆက်လက် လမ်းညွှန်ပေးပါသည်။',
    },
  ],
  journeySection: {
    eyebrow: 'လုပ်ငန်းစဉ်',
    title: 'ဂျပန်ဆီ ခရီးလမ်း',
  ...
  journey: [
    ...
    },
    {
      ...
      description: 'ပါတနာမြို့ ၅ မြို့ထဲက နာမည်ကောင်းကျောင်းနဲ့ ချိတ်ဆက်ပေးပါတယ်။',
    },
    {
  ...
  coursesSection: {
    ...
    subtitle: 'အခြေခံမှ အဆင့်မြင့်အထိ ပို့ဆောင်ပေးမည့် JLPT ပြင်ဆင်မှု အပြည့်အစုံ။',
    features: 'သင်တန်း အကြောင်းအရာ',
    enroll: 'အပ်နှံရန်',
    flexibleTitle: 'လိုက်လျောညီထွေ သင်ယူနည်းများ',
    whyTitle: 'ကျွန်ုပ်တို့ သင်တန်းများ ထိရောက်ရသည့် အကြောင်းရင်း',
  },
  courses: [
    {
    ...
    },
    {
      ...
      level: 'အလယ်အလတ်',
      duration: '၄ လ',
      description: 'JLPT N4 စာမေးပွဲအတွက် သဒ္ဒါ၊ ခန်းဂျီး၊ အဖတ်နှင့် အကြားစွမ်းရည် မြှင့်တင်ပါ။',
      features: [
        'ခန်းဂျီး ၃၀၀ ကျော်',
    ...
    },
    {
      ...
      level: 'အဆင့်မရွေး',
      duration: 'လိုက်လျောညီထွေ',
      description: 'ဂျပန်မှာ နေထိုင်စာသင် ချောမွေ့စွာ လိုက်လျောညီထွေဖြစ်စေမည့် လက်တွေ့စွမ်းရည်နဲ့ ယဉ်ကျေးမှု ဗဟုသုတများ။',
  ...
  learningFormats: [
    ...
    { title: 'Zoom + ဗီဒီယို', description: 'Live အတန်းအပြင် recording ပါရှိလို့ ပြည့်စုံ လိုက်လျောညီထွေ။' },
  ],
  whyCoursesWork: [
    {
  ...
  storiesSection: {
    eyebrow: 'ကျောင်းသား ဇာတ်လမ်းများ',
    ...
    storyName: 'ကျောင်းသား အောင်မြင်မှု ဇာတ်လမ်း',
  ...
  activitiesSection: {
    ...
    shareText: 'သင့်အောင်မြင်မှု ဇာတ်လမ်းကို မျှဝေချင်လား? ဂုဏ်ယူစွာ ဖော်ပြပေးချင်ပါတယ်။',
    shareCta: 'ဇာတ်လမ်း မျှဝေရန် ဆက်သွယ်ပါ',
  },
  activities: [
  ...
  contactCta: {
    ...
    subtitle: 'ရှင်းလင်းတဲ့ လမ်းညွှန်မှုနဲ့ ပံ့ပိုးမှု အပြည့်အစုံအတွက် ကျွန်ုပ်တို့ team ကို ဆက်သွယ်ပါ။',
  ...
  footer: {
    ...
    linkStudy: 'ဂျပန်ပညာတော်',
    linkStories: 'ကျောင်းသား ဇာတ်လမ်းများ',
    linkResults: 'COE ရလဒ်',
    rights: 'မူပိုင်ခွင့် အားလုံး လက်ဝယ်ရှိသည်။',
  },
  contactPage: {
    heroTitle: 'ဆက်သွယ်ရန်',
    heroSub: 'လျှောက်ထားဖို့ အသင့်ဖြစ်ပြီလား၊ မေးစရာရှိလား? Message ပို့လိုက်ပါ — team က မကြာမီ ပြန်လည်ဆက်သွယ်ပါမယ်။',
    address: 'လိပ်စာ',
    phone: 'ဖုန်း',
    email: 'အီးမေးလ်',
    ...
    message: 'Message',
    messagePlaceholder: 'ဘယ်လို ကူညီပေးရမလဲ ပြောပြပါ',
    send: 'Message ပို့ရန်',
    sending: 'ပို့နေသည်...',
    successTitle: 'ကျေးဇူးတင်ပါတယ်!',
    successBody: 'သင့် message ရရှိပြီး မကြာမီ ပြန်လည်ဆက်သွယ်ပါမယ်။',
    sendAnother: 'နောက်ထပ် message ပို့ရန်',
  ...
  studyPage: {
    ...
    ctaSub: 'အဆင့်တိုင်းမှာ ကျွန်ုပ်တို့ team က လမ်းညွှန်ပေးပါမယ်။',
    ctaBtn: 'ဆက်သွယ်ရန်',
  },
  faqPage: {
    heroTitle: 'မေးလေ့ရှိသော မေးခွန်းများ',
    stillTitle: 'မေးစရာ ကျန်သေးလား?',
    stillBody: 'ကျွန်ုပ်တို့ team က ဝမ်းသာစွာ ကူညီပေးပါမယ် — အချိန်မရွေး ဆက်သွယ်ပါ။',
    stillBtn: 'ဆက်သွယ်ရန်',
  },
}
